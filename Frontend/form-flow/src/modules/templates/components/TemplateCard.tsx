...
export const TemplateCard: React.FC<TemplateCardProps> = ({
	...
	if (mode === 'compact') {
		return (
			...
			>
				{template.imageUrl && (
					<div className={`mb-3 ${imageClasses[size]} overflow-hidden rounded-lg`}>
						<img
				...
				<div className="space-y-2">
					<h3 className={`font-semibold text-text line-clamp-2 ${titleClasses[size]}`}>
						{template.title}
					</h3>
	...
	return (
		...
		>
			{template.imageUrl && (
				<div className={`mb-4 ${imageClasses[size]} overflow-hidden rounded-lg`}>
					<img
						src={template.imageUrl}
						alt={template.title}
						className="w-full h-full object-cover"
			...
			<div className="space-y-3">
				<div>
					<h3 className={`font-semibold text-text mb-2 line-clamp-2 ${titleClasses[size]}`}>
						{template.title}
					</h3>
