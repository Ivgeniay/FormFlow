...
export const NavMenu: React.FC<NavMenuProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <nav className="fixed top-0 left-0 w-80 max-w-sm h-full bg-surface border-r border-border shadow-lg transform transition-transform">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3 text-left text-text hover:bg-background rounded-lg transition-colors"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
